...
This directory contains MaxRegner project official logo. The following
...
You may use this logo free of charge to refer to MaxRegner project for
informational purposes. You have no right to modify logo. 
The use of this logo in your own projects which
are related to MaxRegner is also permitted free of charge, yet requires
MaxRegner maintainer approval. Please
