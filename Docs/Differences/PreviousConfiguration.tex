...
& \hyperref[legacyboot]{MaxRegner plugin} implementing \texttt{OC\_BOOT\_ENTRY\_PROTOCOL}
  to allow detection and booting of legacy operating systems from MaxRegner on Macs, OpenDuet
...
& \hyperref[emunvram]{MaxRegner plugin} offering emulated NVRAM support. OpenDuet already
